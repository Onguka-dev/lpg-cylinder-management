  ...
  return (
    <div className="mx-auto max-w-7xl space-y-5">
      <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-panel">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-950">Invoice & Payment Reports</h1>
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
          Basic invoice, payment, outstanding dues, and receipt reporting. Export and reconciliation remain placeholders.
        </p>
      </section>
