  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-5">
        ...
        <InventoryCard href="/inventory/selling-point-dispatches" title="Selling Point Dispatches" description="Dispatch filled Wandiege stock to Ugunja, vans, stations, and service centres." />
