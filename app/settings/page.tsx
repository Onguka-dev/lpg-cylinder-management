    ...
    <div className="mx-auto max-w-5xl space-y-5">
      <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-panel">
        ...
        <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-600">
          Application configuration, security controls, notification controls, and mock integration settings for Admin users.
        </p>
      </section>
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <SettingsCard title="Security Controls" description="Review password policy, MFA readiness, session timeout, and device sessions." href="/settings/security" />
      </section>
    </div>
  );
}
