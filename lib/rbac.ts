...
export const routePermissions: Record<AppRole, string[]> = {
  ADMIN: ["*"],
  WAREHOUSE_MANAGER: ["/", "/warehouse", "/inventory", "/transfers", "/orders", "/deliveries", "/payments", "/reports", "/reconciliations", "/safety", "/api/orders", "/api/deliveries", "/api/billing", "/api/reconciliations", "/api/safety", "/api/cylinders", "/api/inventory"],
