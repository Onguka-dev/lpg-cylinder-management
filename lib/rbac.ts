...
export const routePermissions: Record<AppRole, string[]> = {
  ...
  RSO: ["/", "/profile", "/rso", "/retail-sales", "/retail-inventory", "/customers", "/orders", "/payments", "/reports", "/notifications", "/reconciliations", "/inventory/movements", "/inventory/selling-point-dispatches", "/inventory/empty-return-transfers", "/api/customers", "/api/customer-complaints", "/api/orders", "/api/billing", "/api/reports", "/api/notifications", "/api/reconciliations", "/api/inventory/movements", "/api/inventory/selling-point-dispatches", "/api/inventory/empty-return-transfers", "/api/retail"],
  MSO: ["/", "/profile", "/mso", "/field-sales", "/retail-sales", "/deliveries", "/offline", "/customers", "/orders", "/payments", "/reports", "/notifications", "/reconciliations", "/inventory/movements", "/inventory/selling-point-dispatches", "/inventory/empty-return-transfers", "/api/customers", "/api/customer-complaints", "/api/orders", "/api/deliveries", "/api/offline", "/api/billing", "/api/reports", "/api/notifications", "/api/reconciliations", "/api/inventory/movements", "/api/inventory/selling-point-dispatches", "/api/inventory/empty-return-transfers", "/api/field-sales", "/api/retail/full-cylinder-sales", "/api/retail/refill-orders", "/api/retail/empty-returns"],
