...
export const routePermissions: Record<AppRole, string[]> = {
  ...
  RSO: ["/", "/profile", "/rso", "/retail-sales", "/retail-inventory", "/customers", "/orders", "/payments", "/reports", "/notifications", "/reconciliations", "/inventory/movements", "/api/customers", "/api/customer-complaints", "/api/orders", "/api/billing", "/api/reports", "/api/notifications", "/api/reconciliations", "/api/inventory/movements", "/api/retail"],
  MSO: ["/", "/profile", "/mso", "/field-sales", "/deliveries", "/offline", "/customers", "/orders", "/payments", "/reports", "/notifications", "/reconciliations", "/inventory/movements", "/api/customers", "/api/customer-complaints", "/api/orders", "/api/deliveries", "/api/offline", "/api/billing", "/api/reports", "/api/notifications", "/api/reconciliations", "/api/inventory/movements", "/api/field-sales"],
  SERVICE_CENTRE_STAFF: ["/", "/profile", "/retail-sales", "/retail-inventory", "/customers", "/orders", "/payments", "/reports", "/notifications", "/inventory/movements", "/api/customers", "/api/customer-complaints", "/api/orders", "/api/billing", "/api/reports", "/api/notifications", "/api/inventory/movements", "/api/retail"],
